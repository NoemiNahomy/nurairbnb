...
import event.PropiedadEliminado;
import event.PropiedadHabilitado;
import event.PropiedadModificada;
...
public class Propiedad extends AggregateRoot {
  ...
  public Propiedad(UUID id, String nombre, String estado, double precio)
